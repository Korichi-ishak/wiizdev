...
const seedData = async () => {
    try {
        ...
        await TechStack_1.default.deleteMany({});
        ...
        const admins = [
            ...
            },
            {
                ...
                password: await bcryptjs_1.default.hash('super123', 10),
                name: 'Super Admin',
                role: 'super_admin'
            }
        ];
        await Admin_1.default.insertMany(admins);
        ...
        const createdTechStack = await TechStack_1.default.insertMany(techStackData);
        ...
        const createdProjects = await Project_1.default.insertMany(projectsData);
        ...
        await Settings_1.default.create(settingsData);
