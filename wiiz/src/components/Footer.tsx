      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="py-16">
          <div className="grid lg:grid-cols-12 gap-12">
            ...
            >
              ...
              <div className="mb-6">
                <p className="text-lg font-semibold text-primary italic mb-2">
                  "Building tomorrow's digital experiences, today."
                </p>
                <p className="text-sm text-gray-500">
                  Where innovation meets execution, and dreams become digital reality.
                </p>
              </div>
        ...
        >
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl font-bold mb-3">Join the Innovation Journey</h3>
              <p className="text-gray-400 mb-3">
                Get exclusive insights, behind-the-scenes project stories, and cutting-edge tech trends delivered to your inbox.
              </p>
        ...
        <div className="py-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              © {currentYear} Wiiz Dev. All rights reserved.
            </motion.div>
