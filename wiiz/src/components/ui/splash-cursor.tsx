...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function generateColor() {
      // Use website colors
      const colors = [
        { r: 0.847, g: 0.592, b: 0.235 }, // Primary #D8973C
        { r: 0.153, g: 0.243, b: 0.278 }, // Secondary #273E47
        { r: 0.604, g: 0.400, b: 0.196 }, // Darker primary
        { r: 0.102, g: 0.161, b: 0.184 }, // Darker secondary
      ];
      
      const color = colors[Math.floor(Math.random() * colors.length)];
      
      // Reduce intensity for background effect
      return {
        r: color.r * 0.15,
        g: color.g * 0.15,
        b: color.b * 0.15
